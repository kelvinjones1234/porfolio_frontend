...
const MoreProjects = () => {
  ...
  return (
    <section className="relative pt-[10rem] pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-white">
      {/* Background Elements */}
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-16">
          <h2 className="text-2xl sm:text-4xl font-bold mb-4">
            Featured <span className="text-[#98e8cd]">Projects</span>
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto text-base sm:text-lg">
            Explore some of my featured work and personal projects that showcase
